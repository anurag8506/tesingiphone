...
export default function Header(activePage: activePageProps) {
  ...
  return (
    <section
      className={`fixed w-full z-50 transition-all duration-300 ${isScrolled ? "bg-black shadow-md" : "bg-transparent"
        }`}
    >
        ...
        <div className="col-12 sm:flex justify-between">
            ...
            <div className="sm:flex items-center ">
              <Link href="/">
                <Image
                  ...
                  className="object-contain sm:w-[200px] w-[100px]"
                  width={1080}
                  height={1080}
                  alt="Image"
                />
            ...
            >
              <Link
                ...
                className={`no-underline text-[16px] block sm:py-0 py-[10px] ${activePage.activePage === "HomePage"
                  ? "text-[#EA9A4A] font-bold"
                  : "text-[#fff] hover:text-[#EA9A4A]"
                  }`}
              >
                <li
              ...
              <Link
                href="/about"
                className={(activePage.activePage == "AboutPage") ? "text-[#EA9A4A] no-underline text-[16px]" : " no-underline block sm:py-0 py-[10px] text-[16px] text-[#fff] hover:text-[#EA9A4A] no-underline"}
              >
                <li
              ...
              <div className="relative sm:flex align-center">
                <div className="relative z-50 group">
                  <button
                    className={`group flex items-center text-[16px] sm:py-0 py-[10px] p-0 m-0 ${activePage.activePage === "servicesPage" ? "text-[#EA9A4A]" : "text-[#fff]"
                      }`}
                  >
                    <span>SERVICES</span>
                    <span className="ml-1 text-[10px] transform transition-transform duration-300 group-hover:rotate-180">
                      ...
                      >
                        <path
                          d="M1 1L6 7L11 1"
                          stroke={
                            activePage.activePage === "servicesPage" ? "#EA9A4A" : "currentColor"
                          }
                          strokeWidth="2"
                          className={`transition-colors duration-300 ${activePage.activePage === "servicesPage" ? "stroke-[#EA9A4A]" : ""
                            }`}
                        />
                      </svg>
                    </span>
                  ...
                  <div className="sm:absolute relative left-0 sm:top-[30px] sm:p-[10px] p-0 sm:mt-2 w-[280px] bg-black sm:shadow-md rounded-md transition-all ease-in-out group-hover:!opacity-100 opacity-0 invisible group-hover:!visible h-0 sm:h-auto group-hover:h-auto">
                    <ul className="pl-5 py-0 space-y-2 sm:mt-4 mb-0">
                      {[
                        { href: "/services/mediaproductivity", text: "Media Productivity" },
                        { href: "/services/ui-ux-design", text: "UI/UX Design" },
                        { href: "/services/branding-identity", text: "Branding & Identity" },
                        { href: "/services/creative-designs", text: "Creative Designs" },
                        ...
                        <Link
                          key={index}
                          href={item.href}
                          className={`text-[16px] no-underline block sm:py-0 py-[10px] ${activePage.activePage === item.text ? "text-[#EA9A4A]" : "text-[#fff]"
                            } hover:text-[#EA9A4A] transition-colors duration-300`}
                        >
          ...
          <div className="col-md-3 sm:flex justify-end">
            <div className="hidden md:sm:flex items-center space-x-4">
              <Link
                href="/contact"
                className={`no-underline text-[16px] flex align-items-center px-3 py-2 gap-2 rounded-full 
    ${activePage.activePage === "ContactPage"
                    ? "text-[#fff] bg-[#EA9A4A] border-none hover:border-none"
                    : "text-[#fff] border border-[#fff] hover:border-none hover:bg-[#EA9A4A] hover:text-[#fff]"
                  }`}
              >
